...
Create a non-consumable feature handle. Entity features represent persistent resources like seats, projects, or workspaces — things you add and remove, not consume.
