...
description: "Reference: metered(), boolean(), entity(), creditSystem(), plan() — define features and plans as code"
icon: Blocks
---
...
```ts
// owo.config.ts
import { Owostack, metered, boolean, entity, creditSystem, plan } from "owostack";
