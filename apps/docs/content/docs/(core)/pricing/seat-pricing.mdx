...
```ts
import { metered, plan, Owostack } from "owostack";
...
- [`addEntity()`](/sdk/entities) - Add entities/seats
- [`removeEntity()`](/sdk/entities) - Remove entities
- [`listEntities()`](/sdk/entities) - List entities
