...
Plans can be created through the dashboard or defined in code using the catalog. Both coexist safely. See [Catalog & Sync Model](/guides/catalog-sync) for details on how conflicts are resolved.
...
- [Plans (Dashboard)](/dashboard/plans)
- [Plan switching](/guides/plan-switching)
