...
- [`attach()`](./attach) - Subscribe customer to a plan
- [`addEntity()`](./entities) - Add entities/seats (flat API)
- [Seat Pricing Guide](/docs/guides/seat-pricing) - Complete seat-based billing walkthrough
