...
Subscribe a customer to a subscription plan. This initiates the checkout flow with Paystack.
...
interface AttachResult {
  ...
  checkoutUrl?: string; // Paystack checkout URL (for new subscriptions)
  error?: string;
}
```
...
- Paystack handles the payment UI - you just redirect the customer
