...
- [`customer()`](./customer) - Create and manage customers
- [`check()`](./check) - Check feature access (supports entity scope)
- [`track()`](./track) - Track usage (supports entity scope)
- [Seat Pricing Guide](/docs/guides/seat-pricing) - Complete walkthrough
