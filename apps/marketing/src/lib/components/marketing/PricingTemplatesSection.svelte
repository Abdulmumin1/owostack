...
<section
  class="overflow-hidden border-y border-border/40 bg-bg-primary py-24 md:py-32"
>
  <div class="mx-auto max-w-6xl px-6">
    <div class="mb-16">
      <h2
        class="max-w-2xl text-4xl font-bold tracking-tight text-text-primary md:text-5xl"
      >
        Steal Pricing models from companies you trust.
      </h2>
      <p
        class="mt-4 max-w-xl text-sm leading-relaxed text-text-secondary md:text-base"
      >
        Copy the exact billing patterns used by OpenAI Codex, Clerk, Cursor,
        Resend and other companies.
      </p>
    </div>
  </div>
    ...
    <div class="marquee-container flex gap-6 px-6">
      <div class="marquee-content flex gap-6">
        {#each [...templates, ...templates] as template}
          <article
            class="card card-elevated card-interactive group flex h-130 w-[320px] shrink-0 flex-col !shadow-none !rounded-xl !p-0"
          >
            <div class="rounded-t-[11px] border-b border-border/50 p-6">
              <div class="flex items-center justify-between mb-4">
                <div
                  class="flex items-center justify-center rounded-sm overflow-hidden border border-border bg-bg-secondary text-text-muted transition-colors group-hover:border-accent/30 group-hover:text-accent"
                >
                  <InspiredLogo
              ...
              <div
                class="mb-3 flex items-center gap-1.5 text-[10px] text-text-dim"
              >
            ...
            <div class="flex-1 bg-bg-secondary/30 px-6 py-5">
              <div
                class="mb-5 flex items-center justify-between border-b border-border/40 pb-2"
              >
                <div
                ...
                <div class="text-[10px] font-medium text-text-dim">
                  Postpaid
                </div>
              </div>
              ...
              <div class="space-y-4">
                {#each template.breakdown.slice(0, 3) as item}
                  <div
                    class="flex items-center justify-between gap-2 border-b border-border/30 pb-2 last:border-0"
                  >
                    <span
              ...
              <div class="mt-8">
                <p
                  class="text-sm leading-relaxed text-text-secondary italic line-clamp-2"
                >
                  "{template.rules[0]}"
                </p>
              </div>
            ...
            <div
              class=" rounded-b-xl border-t border-border/50 bg-bg-card px-6 py-5"
            >
  ...
  <div class="mx-auto mt-20 flex max-w-6xl justify-center px-6">
    <a
      ...
      class="btn btn-primary gap-2 px-8 py-3 text-sm"
    >
