/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: df86c1c51da3507d462cc2c844693d4c)
// Runtime types generated with workerd@1.20260131.0 2026-01-31 durable_object_alarms,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UsageMeterDO" | "UsageLedgerDO";
	}
	interface TestEnv {
		API_KEYS: KVNamespace;
		CACHE: KVNamespace;
		CACHE_SHARED: KVNamespace;
		DB: D1Database;
		DB_AUTH: D1Database;
		ANALYTICS: AnalyticsEngineDataset;
		OVERAGE_BILLING_QUEUE: Queue;
		ENVIRONMENT: "test";
		ANALYTICS_DATASET: "owostack_api_test";
		BETTER_AUTH_URL: "https://sandbox.owostack.com";
	...
	interface LiveEnv {
		...
		OVERAGE_BILLING_QUEUE: Queue;
		ENVIRONMENT: "live";
		ANALYTICS_DATASET: "owostack_api_live";
	...
	interface Env {
		...
		ANALYTICS_DATASET: "owostack_api_test" | "owostack_api_live" | "owostack_api_dev";
		BETTER_AUTH_URL: "https://sandbox.owostack.com" | "https://api.owostack.com" | "http://localhost:8787/api/auth";
		USAGE_METER?: DurableObjectNamespace<import("./src/index").UsageMeterDO>;
		USAGE_LEDGER?: DurableObjectNamespace<import("./src/index").UsageLedgerDO>;
		TRIAL_END_WORKFLOW?: Workflow<Parameters<import("./src/index").TrialEndWorkflow['run']>[0]['payload']>;
		DOWNGRADE_WORKFLOW?: Workflow<Parameters<import("./src/index").DowngradeWorkflow['run']>[0]['payload']>;
		PLAN_UPGRADE_WORKFLOW?: Workflow<Parameters<import("./src/index").PlanUpgradeWorkflow['run']>[0]['payload']>;
		OVERAGE_BILLING_WORKFLOW?: Workflow<Parameters<import("./src/index").OverageBillingWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ANALYTICS_DATASET" | "BETTER_AUTH_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "ENCRYPTION_KEY" | "DASHBOARD_URL">> {}
}
