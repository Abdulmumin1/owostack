...
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    TRIAL_END_WORKFLOW?: Workflow<
      Parameters<import("./src/index").TrialEndWorkflow["run"]>[0]["payload"]
    >;
    DOWNGRADE_WORKFLOW?: Workflow<
      Parameters<import("./src/index").DowngradeWorkflow["run"]>[0]["payload"]
    >;
    PLAN_UPGRADE_WORKFLOW?: Workflow<
      Parameters<import("./src/index").PlanUpgradeWorkflow["run"]>[0]["payload"]
    >;
    OVERAGE_BILLING_WORKFLOW?: Workflow<
      Parameters<
        import("./src/index").OverageBillingWorkflow["run"]
      >[0]["payload"]
    >;
  }
}
